...
FEMALE_WORDS = {'heroine', 'spokeswoman', 'chairwoman', "women's", 'actress', 'women', "she's", 'her', 'aunt', 'aunts',
                ...
                'goddess', 'granddaughter', 'grandma', 'grandmother', 'herself', 'ladies', 'lady', 'mom', 'moms',
                'mother', 'mothers', 'mrs', 'ms', 'niece', 'nieces', 'priestess', 'princess', 'queens', 'she', 'sister',
...
def parse_gender(text):
    ...
    for gender,count in words.items():
        ...
        nsents = sents[gender]
        print('{0:0.2f}%  {1} ({2} sentences)'.format(pcent,gender,nsents))
